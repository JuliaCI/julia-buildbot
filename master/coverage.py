...
julia_coverage_scheduler = Triggerable(name="Julia Coverage Testing", builderNames=julia_coverage_slaves)
...
results=Coveralls.process_folder(joinpath(CoverageBase.julia_top(), "base"))
