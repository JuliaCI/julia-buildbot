...
osx_names = ["osx10.8", "osx10.9", "osx10.10"]
centos_names = ["centos5.11-x64", "centos5.11-x86", "centos7.0-x64"]
win_names = ["win8.1-x64", "win8.1-x86"]
...
for name in all_names:
    ...
    # Everything should be parallelized!
    flags += '-j4 '
