...
packager_scheduler = schedulers.SingleBranchScheduler(name="Julia packaging", change_filter=util.ChangeFilter(branch='master'), builderNames=julia_packagers, treeStableTimer=1)
