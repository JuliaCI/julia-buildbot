...
packager_scheduler = schedulers.AnyBranchScheduler(name="Julia binary packaging", change_filter=util.ChangeFilter(project_re='.*/julia$', branch='master'), builderNames=julia_packagers, treeStableTimer=1)
